<fieldset>
    ...
    <input type="text" name="propiedad[titulo]" id="titulo" placeholder="Ingresa el Título" value="<?php echo s($propiedad->titulo); ?>">

    <label for="precio">Precio</label>
    <input type="number" name="propiedad[precio]" id="precio" placeholder="Ingresa el precio" value="<?php echo s($propiedad->precio); ?>">
...
<fieldset>
    ...
    <input type="number" name="propiedad[wc]" id="precio" placeholder="Ej: 3" min="1" max="9" value="<?php echo s($propiedad->wc); ?>">
...
<fieldset>
    ...
    <select id="vendedor_id" name="propiedad[vendedor_id]">
